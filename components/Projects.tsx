...
const Projects = (props: Props) => {
  ...
  const projects = [
    {image: KamalProject, swiperImgs:[{key:'1',link: KamalProject1},{key:'2',link:KamalProject2},{key:'3',link:KamalProject3},{key:'4',link:KamalProject4},{key:'5',link: KamalProject5},{key:'6',link:KamalProject6},{key:'7',link:KamalProject7},{key:'8',link: KamalProject8},{key:'9',link:KamalProject9}] ,title: "Client Landing Page" , description:[{section:'Situation', content:' As a freelance web developer, I collaborated with a client who owns an English teaching school. The client expressed the need for a professional online presence to enhance their credibility and increase visibility to high-value clients.'},{section:'Task', content:'My task was to design and develop a visually appealing landing page that effectively showcased the clients English teaching services. The goal was to create a platform where the client could demonstrate professionalism and highlight positive feedback from students'},{section:'Action', content:' began by conducting thorough research on the clients business, target audience, and competitors. I collaborated closely with the client to understand their specific requirements and preferences. Using React, HTML, CSS,TailwindCSS and JavaScript, I designed a sleek and modern landing page that reflected the professionalism and expertise of the English teaching school. I incorporated compelling visuals, testimonials from satisfied students, and clear calls-to-action to engage visitors and encourage inquiries.'} ,{section:'Result', content:'The completed landing page provided the client with a polished online presence that effectively showcased their English teaching services. The client reported increased interest from high-end clients and noted a significant improvement in their online visibility. The landing page served as a valuable tool for the client to demonstrate professionalism and attract potential students, ultimately contributing to the growth and success of the English teaching school.'} ], repo:'', demo:'https://stg.followmeacademy.com/'},
